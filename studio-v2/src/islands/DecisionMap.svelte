...
<style>
  ...
  .dm-badge.req { background: #e8f4fd; color: var(--accent); border: 1px solid #b6d4fe; }
  ...
  .dm-chip.green { background: #ebfbee; border: 1px solid #8ce99a; color: #2b8a3e; font-weight: 500; }
