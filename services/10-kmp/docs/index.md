...
Runnable service starter for Kotlin Multiplatform.

## What this is

Kotlin Multiplatform is a kotlin mobile-cross service starter.
...
All files live in `services/10-kmp/` in the pipeline-studio repo.
