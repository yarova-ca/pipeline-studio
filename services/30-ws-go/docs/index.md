...
Runnable service starter for Gorilla WS (Go).

## What this is

Gorilla WS (Go) is a go websocket service starter.
...
All files live in `services/30-ws-go/` in the pipeline-studio repo.
