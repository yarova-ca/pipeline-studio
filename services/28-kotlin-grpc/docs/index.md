...
Runnable service starter for Kotlin gRPC.

## What this is

Kotlin gRPC is a kotlin grpc service starter.
...
All files live in `services/28-kotlin-grpc/` in the pipeline-studio repo.
