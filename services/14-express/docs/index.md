...
Runnable service starter for Express 5.

## What this is

Express 5 is a typescript backend service starter.
...
| PKG_MGR | npm | Package manager used at build. |
...
| BUILD_TOOL | tsc | Compiler or bundler used. |
...
All files live in `services/14-express/` in the pipeline-studio repo.
