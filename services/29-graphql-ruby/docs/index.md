...
Runnable service starter for GraphQL Ruby.

## What this is

GraphQL Ruby is a ruby graphql service starter.
...
All files live in `services/29-graphql-ruby/` in the pipeline-studio repo.
