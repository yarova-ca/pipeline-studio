...
Runnable service starter for Action Cable.

## What this is

Action Cable is a ruby websocket service starter.
...
All files live in `services/30-ws-ruby/` in the pipeline-studio repo.
