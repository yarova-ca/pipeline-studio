...
Runnable service starter for MF Webpack.

## What this is

MF Webpack is a typescript mf service starter.
...
All files live in `services/08-mf-webpack/` in the pipeline-studio repo.
