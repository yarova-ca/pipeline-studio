...
Runnable service starter for SignalR (.NET).

## What this is

SignalR (.NET) is a csharp websocket service starter.
...
All files live in `services/30-ws-dotnet/` in the pipeline-studio repo.
