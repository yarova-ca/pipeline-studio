...
Runnable service starter for React Native.

## What this is

React Native is a typescript mobile-rn service starter.
...
Build with the typescript platform toolchain.

See the files in this service for exact build steps.

## Source

All files live in `services/09-react-native/` in the pipeline-studio repo.
