...
Runnable service starter for ObjC UIKit.

## What this is

ObjC UIKit is a objc mobile-ios service starter.
...
Build with the objc platform toolchain.

See the files in this service for exact build steps.

## Source

All files live in `services/11-objc-uikit/` in the pipeline-studio repo.
