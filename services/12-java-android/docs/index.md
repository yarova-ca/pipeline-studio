...
Runnable service starter for Java Android.

## What this is

Java Android is a java mobile-android service starter.
...
Build with the java platform toolchain.

See the files in this service for exact build steps.

## Source

All files live in `services/12-java-android/` in the pipeline-studio repo.
