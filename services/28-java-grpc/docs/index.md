...
Runnable service starter for Java gRPC.

## What this is

Java gRPC is a java grpc service starter.
...
| RUNTIME | temurin | Base runtime image (standard or FIPS). |
...
All files live in `services/28-java-grpc/` in the pipeline-studio repo.
