...
Runnable service starter for Astro (static).

## What this is

Astro (static) is a typescript spa service starter.
...
All files live in `services/03-astro/` in the pipeline-studio repo.
