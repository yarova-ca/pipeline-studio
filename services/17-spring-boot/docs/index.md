...
Runnable service starter for Spring Boot.

## What this is

Spring Boot is a java backend service starter.
...
| RUNTIME | distroless | Base runtime image (standard or FIPS). |
...
All files live in `services/17-spring-boot/` in the pipeline-studio repo.
