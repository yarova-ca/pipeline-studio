...
Runnable service starter for Apollo GraphQL.

## What this is

Apollo GraphQL is a typescript graphql service starter.
...
All files live in `services/29-apollo/` in the pipeline-studio repo.
