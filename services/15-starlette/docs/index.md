...
Runnable service starter for Starlette.

## What this is

Starlette is a python backend service starter.
...
All files live in `services/15-starlette/` in the pipeline-studio repo.
