...
Runnable service starter for .NET Minimal APIs.

## What this is

.NET Minimal APIs is a csharp backend service starter.
...
All files live in `services/19-minimal-apis/` in the pipeline-studio repo.
