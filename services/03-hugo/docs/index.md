...
Runnable service starter for Hugo.

## What this is

Hugo is a go spa service starter.
...
Build with the go platform toolchain.

See the files in this service for exact build steps.

## Source

All files live in `services/03-hugo/` in the pipeline-studio repo.
