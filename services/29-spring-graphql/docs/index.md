...
Runnable service starter for Spring GraphQL.

## What this is

Spring GraphQL is a java graphql service starter.
...
All files live in `services/29-spring-graphql/` in the pipeline-studio repo.
