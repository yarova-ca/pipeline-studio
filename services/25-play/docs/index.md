...
Runnable service starter for Play Framework.

## What this is

Play Framework is a scala backend service starter.
...
All files live in `services/25-play/` in the pipeline-studio repo.
