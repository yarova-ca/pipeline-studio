...
Runnable service starter for Hummingbird.

## What this is

Hummingbird is a swift backend service starter.
...
All files live in `services/24-hummingbird/` in the pipeline-studio repo.
