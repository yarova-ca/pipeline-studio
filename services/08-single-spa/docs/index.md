...
Runnable service starter for Single SPA.

## What this is

Single SPA is a typescript mf service starter.
...
All files live in `services/08-single-spa/` in the pipeline-studio repo.
