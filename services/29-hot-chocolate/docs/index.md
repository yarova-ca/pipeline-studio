...
Runnable service starter for Hot Chocolate (.NET).

## What this is

Hot Chocolate (.NET) is a csharp graphql service starter.
...
All files live in `services/29-hot-chocolate/` in the pipeline-studio repo.
