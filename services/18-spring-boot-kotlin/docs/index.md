...
Runnable service starter for Spring Boot Kotlin.

## What this is

Spring Boot Kotlin is a kotlin backend service starter.
...
All files live in `services/18-spring-boot-kotlin/` in the pipeline-studio repo.
