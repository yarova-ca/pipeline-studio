...
Runnable service starter for Flutter.

## What this is

Flutter is a dart mobile-cross service starter.
...
Build with the dart platform toolchain.

See the files in this service for exact build steps.

## Source

All files live in `services/10-flutter/` in the pipeline-studio repo.
