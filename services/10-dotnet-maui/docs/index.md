...
Runnable service starter for .NET MAUI.

## What this is

.NET MAUI is a csharp mobile-cross service starter.
...
Build with the csharp platform toolchain.

See the files in this service for exact build steps.

## Source

All files live in `services/10-dotnet-maui/` in the pipeline-studio repo.
