...
Runnable service starter for Remix (advanced).

## What this is

Remix (advanced) is a typescript ssr service starter.
...
All files live in `services/07-remix/` in the pipeline-studio repo.
