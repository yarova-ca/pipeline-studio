...
Runnable service starter for SolidStart.

## What this is

SolidStart is a typescript ssr service starter.
...
All files live in `services/01-solid-start/` in the pipeline-studio repo.
