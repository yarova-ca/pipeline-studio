...
Runnable service starter for ASP.NET Core.

## What this is

ASP.NET Core is a csharp backend service starter.
...
All files live in `services/19-aspnet-core/` in the pipeline-studio repo.
