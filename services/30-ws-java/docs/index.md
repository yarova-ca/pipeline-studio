...
Runnable service starter for Spring WebSocket.

## What this is

Spring WebSocket is a java websocket service starter.
...
All files live in `services/30-ws-java/` in the pipeline-studio repo.
