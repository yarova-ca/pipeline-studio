...
Runnable service starter for Next.js App Router.

## What this is

Next.js App Router is a typescript ssr service starter.
...
All files live in `services/07-nextjs-app-router/` in the pipeline-studio repo.
