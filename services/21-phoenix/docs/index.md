...
Runnable service starter for Phoenix.

## What this is

Phoenix is a elixir backend service starter.
...
| RUNTIME | debian | Base runtime image (standard or FIPS). |
...
All files live in `services/21-phoenix/` in the pipeline-studio repo.
