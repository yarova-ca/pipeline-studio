...
Runnable service starter for Node gRPC.

## What this is

Node gRPC is a typescript grpc service starter.
...
All files live in `services/28-node-grpc/` in the pipeline-studio repo.
