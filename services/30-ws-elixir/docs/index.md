...
Runnable service starter for Phoenix Channels.

## What this is

Phoenix Channels is a elixir websocket service starter.
...
All files live in `services/30-ws-elixir/` in the pipeline-studio repo.
