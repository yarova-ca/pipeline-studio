...
Runnable service starter for Python gRPC.

## What this is

Python gRPC is a python grpc service starter.
...
Health endpoint: `http://localhost:50051/health`.

## Source

All files live in `services/28-python-grpc/` in the pipeline-studio repo.
