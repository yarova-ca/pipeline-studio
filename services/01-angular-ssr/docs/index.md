...
Runnable service starter for Angular SSR.

## What this is

Angular SSR is a typescript ssr service starter.
...
All files live in `services/01-angular-ssr/` in the pipeline-studio repo.
