...
Runnable service starter for Next.js Edge.

## What this is

Next.js Edge is a typescript edge service starter.
...
All files live in `services/06-nextjs-edge/` in the pipeline-studio repo.
