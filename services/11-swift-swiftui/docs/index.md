...
Runnable service starter for SwiftUI.

## What this is

SwiftUI is a swift mobile-ios service starter.
...
Build with the swift platform toolchain.

See the files in this service for exact build steps.

## Source

All files live in `services/11-swift-swiftui/` in the pipeline-studio repo.
