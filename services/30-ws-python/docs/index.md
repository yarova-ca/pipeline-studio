...
Runnable service starter for FastAPI WS.

## What this is

FastAPI WS is a python websocket service starter.
...
All files live in `services/30-ws-python/` in the pipeline-studio repo.
