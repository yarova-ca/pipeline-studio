...
Runnable service starter for Astro (islands).

## What this is

Astro (islands) is a typescript ssr service starter.
...
All files live in `services/04-astro/` in the pipeline-studio repo.
