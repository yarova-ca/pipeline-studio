---
name: "[15 Python] Starlette 0.41 — pipeline setup"
about: "Pipeline setup for Starlette 0.41 (15 Python). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**FIPS runtime:** `registry.access.redhat.com/ubi9/python-39`
...
**IDE setup:** Pylance + Black + Ruff + SonarLint (VS Code / PyCharm)
...
**Tests + Codecov:**
`pytest --cov=. --cov-report=xml && codecov`
