---
name: "[26 Clojure] Pedestal 0.7 — pipeline setup"
about: "Pipeline setup for Pedestal 0.7 (26 Clojure). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** Calva + VS Code (Calva extension)
...
**Tests + Codecov:**
`lein test  # or clojure -M:test && codecov`
