---
name: "[01 SSR/Hybrid] Angular SSR 20 — pipeline setup"
about: "Pipeline setup for Angular SSR 20 (01 SSR/Hybrid). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
| Tool | Command |
|---|---|
| OWASP ZAP | `zap-baseline.py -t http://localhost:4000` |
| Nuclei | `nuclei -u http://localhost:4000 -severity medium,high,critical` |
| Burp Suite API | `burp-rest-api --burp-headless -u http://localhost:4000` |
