---
name: "[22 Ruby] Sinatra 4.0 — pipeline setup"
about: "Pipeline setup for Sinatra 4.0 (22 Ruby). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**FIPS runtime:** `registry.access.redhat.com/ubi9/ruby-32`
...
**IDE setup:** Solargraph + RuboCop + VS Code
...
**Tests + Codecov:**
`bundle exec rspec --format documentation && codecov`
