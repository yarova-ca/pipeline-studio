---
name: "[03 SSG] Hugo 0.161 — pipeline setup"
about: "Pipeline setup for Hugo 0.161 (03 SSG). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** Hugo CLI + VS Code (Hugo Language Server)
