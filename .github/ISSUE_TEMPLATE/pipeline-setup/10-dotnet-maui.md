---
name: "[10 Cross-platform non-JS] .NET MAUI 10 — pipeline setup"
about: "Pipeline setup for .NET MAUI 10 (10 Cross-platform non-JS). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
