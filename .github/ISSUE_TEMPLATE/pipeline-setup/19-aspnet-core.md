---
name: "[19 .NET] ASP.NET Core 9 — pipeline setup"
about: "Pipeline setup for ASP.NET Core 9 (19 .NET). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
