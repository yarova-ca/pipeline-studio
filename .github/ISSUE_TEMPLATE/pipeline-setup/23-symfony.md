---
name: "[23 PHP] Symfony 7.2 — pipeline setup"
about: "Pipeline setup for Symfony 7.2 (23 PHP). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** PhpStorm + Psalm + PHP_CodeSniffer
...
**Tests + Codecov:**
`vendor/bin/phpunit --coverage-clover coverage.xml && codecov`
