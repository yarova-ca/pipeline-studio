---
name: "[24 Swift Server] Hummingbird 2.0 — pipeline setup"
about: "Pipeline setup for Hummingbird 2.0 (24 Swift Server). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**Pattern:** Multi-stage
**Language:** Swift Server
**Runtime image:** `swift:6.0-noble-slim`
**FIPS runtime:** `swift:6.0-noble-slim (no dedicated FIPS variant)`
...
**IDE setup:** Xcode + Swift Package Manager + sourcekit-lsp
...
**Tests + Codecov:**
`swift test --enable-code-coverage && codecov`
