---
name: "[16 Go] Fiber 3.0 — pipeline setup"
about: "Pipeline setup for Fiber 3.0 (16 Go). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** gopls + staticcheck + golangci-lint (VS Code / GoLand)
...
**Tests + Codecov:**
`go test ./... -coverprofile=coverage.out && codecov`
