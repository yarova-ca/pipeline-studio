---
name: "[18 Kotlin] Spring Boot Kotlin 3.4 — pipeline setup"
about: "Pipeline setup for Spring Boot Kotlin 3.4 (18 Kotlin). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** IntelliJ IDEA + SonarLint + Detekt plugin
