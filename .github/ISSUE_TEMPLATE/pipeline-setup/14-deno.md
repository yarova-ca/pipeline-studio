---
name: "[14 Node/Deno/Bun] Deno 2.3 — pipeline setup"
about: "Pipeline setup for Deno 2.3 (14 Node/Deno/Bun). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**FIPS runtime:** `denoland/deno:2.3-alpine (no dedicated FIPS variant)`
...
**IDE setup:** Deno + VS Code (Deno extension)
...
| Tool | Command |
|---|---|
| OWASP ZAP | `zap-baseline.py -t http://localhost:8000` |
| Nuclei | `nuclei -u http://localhost:8000 -severity medium,high,critical` |
| Burp Suite API | `burp-rest-api --burp-headless -u http://localhost:8000` |
