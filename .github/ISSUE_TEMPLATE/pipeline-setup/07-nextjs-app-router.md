---
name: "[07 Streaming SSR] Next.js App Router 16 — pipeline setup"
about: "Pipeline setup for Next.js App Router 16 (07 Streaming SSR). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**FIPS runtime:** `registry.access.redhat.com/ubi9/nodejs-22-minimal`
...
| Tool | Command |
|---|---|
| OWASP ZAP | `zap-baseline.py -t http://localhost:3000` |
| Nuclei | `nuclei -u http://localhost:3000 -severity medium,high,critical` |
| Burp Suite API | `burp-rest-api --burp-headless -u http://localhost:3000` |
