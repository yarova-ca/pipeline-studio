---
name: "[19 .NET] Minimal APIs .NET 9 — pipeline setup"
about: "Pipeline setup for Minimal APIs .NET 9 (19 .NET). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**FIPS runtime:** `mcr.microsoft.com/dotnet/aspnet:9.0-cbl-mariner2.0-fips`
...
**IDE setup:** JetBrains Rider + Roslyn Analyzer + SonarLint
