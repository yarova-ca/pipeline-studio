---
name: "[11 Native iOS] Objective-C UIKit SDK 17 — pipeline setup"
about: "Pipeline setup for Objective-C UIKit SDK 17 (11 Native iOS). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** Xcode + Instruments + SwiftLint
...
- [ ] Phase 3 app build clean — IPA produced
