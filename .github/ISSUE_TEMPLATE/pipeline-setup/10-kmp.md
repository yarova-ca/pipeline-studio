---
name: "[10 Cross-platform non-JS] Kotlin Multiplatform 2.1 — pipeline setup"
about: "Pipeline setup for Kotlin Multiplatform 2.1 (10 Cross-platform non-JS). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
