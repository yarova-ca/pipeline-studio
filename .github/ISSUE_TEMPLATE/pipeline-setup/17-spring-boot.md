---
name: "[17 Java] Spring Boot 3.4 — pipeline setup"
about: "Pipeline setup for Spring Boot 3.4 (17 Java). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** IntelliJ IDEA + SonarLint + SpotBugs plugin
...
**Tests + Codecov:**
`mvn test  # or ./gradlew test && codecov`
