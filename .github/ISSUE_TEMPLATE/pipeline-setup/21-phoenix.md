---
name: "[21 Elixir/BEAM] Phoenix 1.7 — pipeline setup"
about: "Pipeline setup for Phoenix 1.7 (21 Elixir/BEAM). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**FIPS runtime:** `registry.access.redhat.com/ubi9/ubi-minimal`
...
**IDE setup:** ElixirLS + VS Code (ElixirLS extension)
