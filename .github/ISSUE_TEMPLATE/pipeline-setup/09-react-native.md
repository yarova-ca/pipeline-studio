---
name: "[09 Cross-platform JS] React Native 0.79 — pipeline setup"
about: "Pipeline setup for React Native 0.79 (09 Cross-platform JS). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** ESLint + React Native Tools (VS Code)
...
**Build (no container):**
`npx react-native build-android  # or: eas build --profile preview --platform android`
