---
name: "[25 Scala] Play 3.0 — pipeline setup"
about: "Pipeline setup for Play 3.0 (25 Scala). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**FIPS runtime:** `registry.access.redhat.com/ubi9/openjdk-21-runtime`
...
**IDE setup:** IntelliJ IDEA + Metals + Scalafmt
...
| Tool | Command |
|---|---|
| OWASP ZAP | `zap-baseline.py -t http://localhost:9000` |
| Nuclei | `nuclei -u http://localhost:9000 -severity medium,high,critical` |
| Burp Suite API | `burp-rest-api --burp-headless -u http://localhost:9000` |
