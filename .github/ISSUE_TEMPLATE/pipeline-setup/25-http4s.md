---
name: "[25 Scala] http4s 0.23 — pipeline setup"
about: "Pipeline setup for http4s 0.23 (25 Scala). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
