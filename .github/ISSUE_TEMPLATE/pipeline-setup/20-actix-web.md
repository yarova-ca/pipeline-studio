---
name: "[20 Rust] Actix-web 4.9 — pipeline setup"
about: "Pipeline setup for Actix-web 4.9 (20 Rust). Covers Phase 0–3, all 6 registries, DEV→PROD promotions, and all 11 compliance standards."
...
**IDE setup:** rust-analyzer + VS Code (rust-analyzer extension)
